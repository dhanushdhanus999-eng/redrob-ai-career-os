"""Phase 3 Day 13: experience and education feature generation."""
...
def main() -> None:
    ...
    for split in args.splits:
        ...
        feature_df = generate_feature_frames(
            pair_inputs,
            feature_names=["features_experience"],
        )["features_experience"]
        output_path = save_feature_frame(feature_df, "features_experience", split)
        print(f"[{split}] saved {len(feature_df)} experience rows to {output_path}")
