"""Phase 3 Day 12: skill feature generation."""
...
def main() -> None:
    ...
    for split in args.splits:
        ...
        feature_df = generate_feature_frames(
            pair_inputs,
            feature_names=["features_skills"],
        )["features_skills"]
        output_path = save_feature_frame(feature_df, "features_skills", split)
        print(f"[{split}] saved {len(feature_df)} skill rows to {output_path}")
